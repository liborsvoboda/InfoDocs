...
namespace DocumentSerialization
{
    public static class Util
    {
        ...
        public static string GetBrushesFromString(string value)
        {
            ...
            if (string.Compare(value, Brushes.DarkEasyITCenterrod.ToString()) == 0) return "DarkEasyITCenterrod";
            ...
            if (string.Compare(value, Brushes.EasyITCenterrod.ToString()) == 0) return "EasyITCenterrod";
            ...
            if (string.Compare(value, Brushes.LightEasyITCenterrodYellow.ToString()) == 0) return "LightEasyITCenterrodYellow";
            ...
            if (string.Compare(value, Brushes.PaleEasyITCenterrod.ToString()) == 0) return "PaleEasyITCenterrod";
            ...
            if (null != colorString)
            {
                ...
                switch (colorUpper.Length)
                {
                    ...
                    case 9:
                        switch (colorUpper[0])
                        {
                            ...
                            case 'G':
                                ...
                                if (colorUpper.Equals("EasyITCenterROD")) return Brushes.EasyITCenterrod;
                                break;
                            case 'I':
                    ...
                    case 13:
                        switch (colorUpper[0])
                        {
                            case 'D':
                                ...
                                if (colorUpper.Equals("DARKEasyITCenterROD")) return Brushes.DarkEasyITCenterrod;
                            ...
                            case 'L':
                                ...
                                break;
                            case 'P':
                                if (colorUpper.Equals("PALEEasyITCenterROD")) return Brushes.PaleEasyITCenterrod;
                    ...
                    case 17:
                        ...
                        break;
                    case 20:
                        if (colorUpper.Equals("LIGHTEasyITCenterRODYELLOW")) return Brushes.LightEasyITCenterrodYellow;
                        break;
                }
            }
            return null;

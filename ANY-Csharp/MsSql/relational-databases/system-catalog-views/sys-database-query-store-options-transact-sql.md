...
**Applies to**: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ([!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] and later), [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)].

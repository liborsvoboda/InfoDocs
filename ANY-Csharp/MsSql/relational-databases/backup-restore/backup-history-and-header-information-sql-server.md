...
### Which Backup Set to Restore  
 ...
 ![Backup media containing SQL Server backup sets](../../relational-databases/backup-restore/media/bnr-media-backup-sets.gif "Backup media containing SQL Server backup sets")  

...
|EventSubClass|**int**|1=Execution Context Hit: A free execution plan was found in the plan cache.<br /><br /> 2=Compplan Hit: A compiled plan was found in the plan cache.|21|Yes|  

...
|EventClass|**int**|Type of event = 72.|27||  
|EventSequence|**int**|Sequence of a given event within the request.|51||  
|GroupID|**int**|ID of the workload group where the SQL Trace event fires.|66|Yes|  
|Handle|**int**|Handle of the prepared SQL statement.|33|Yes|  

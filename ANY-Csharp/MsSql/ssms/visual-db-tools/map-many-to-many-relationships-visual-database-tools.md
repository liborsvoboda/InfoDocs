...
5.  In the junction table, set the primary key to include all the primary key columns from the other two tables. For details, see [How to: Create Primary Keys](https://msdn.microsoft.com/85c623ca-4656-4d70-a9db-ee4d897cd214).  
  
6.  Define a one-to-many relationship between each of the two primary tables and the junction table. The junction table should be at the "many" side of both of the relationships you create. For details, see [How to: Create Relationships Between Tables](https://msdn.microsoft.com/867a54b8-5be4-46e6-9702-49ae6dabf67c).  

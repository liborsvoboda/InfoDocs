...
|------------------------|-----------|  
|**.NET CLR Data** and **.NET CLR Memory**|The web portal uses [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] performance counters. For more information, see "Improving .NET Application Performance and Scalability" on MSDN.|  

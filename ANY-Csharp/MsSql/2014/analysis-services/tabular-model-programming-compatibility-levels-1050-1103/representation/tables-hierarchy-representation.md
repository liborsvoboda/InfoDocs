...
### Hierarchy in AMO  
 When using AMO to manage a tabular model table, there is a one-to-one object match for a hierarchy in AMO. A hierarchy is represented by the <xref:Microsoft.AnalysisServices.Hierarchy> object.  

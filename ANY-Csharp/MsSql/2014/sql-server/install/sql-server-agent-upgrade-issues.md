---
title: "SQL Server Agent Upgrade Issues | Microsoft Docs"
ms.custom: ""
ms.date: "06/13/2017"
...
-   [Database maintenance plans superseded](../../../2014/sql-server/install/database-maintenance-plans-superseded.md)  
...
-   [SQL Server Agent Service cannot use SQL Server Authentication](../../../2014/sql-server/install/sql-server-agent-service-cannot-use-sql-server-authentication.md)  
  
-   [Update token syntax in SQL Server Agent job steps](../../../2014/sql-server/install/update-token-syntax-in-sql-server-agent-job-steps.md)  
  
-   [Upgrade all target servers before upgrading the master server](../../../2014/sql-server/install/upgrade-all-target-servers-before-upgrading-the-master-server.md)  

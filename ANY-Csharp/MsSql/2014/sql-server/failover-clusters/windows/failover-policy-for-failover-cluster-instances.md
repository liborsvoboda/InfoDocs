...
2.  [Determining Failures](failover-policy-for-failover-cluster-instances.md#determine)  
...
5.  events  
 ...
 Each rowset of information is also written to the SQL Server cluster diagnostics log. For more information, see [View and Read Failover Cluster Instance Diagnostics Log](view-and-read-failover-cluster-instance-diagnostics-log.md).  
...
####  <a name="determine"></a> Determining Failures  
 ...
 Review [sp_server_diagnostics &#40;Transact-SQL&#41;](/sql/relational-databases/system-stored-procedures/sp-server-diagnostics-transact-sql) as this system stored procedure plays in important role in the failure condition levels.  
...
####  <a name="respond"></a> Responding to Failures  
 ...
 For more information on maintaining quorum health, see [WSFC Quorum Modes and Voting Configuration &#40;SQL Server&#41;](wsfc-quorum-modes-and-voting-configuration-sql-server.md).  

...
Class Program
    ...
    Shared Sub Main(ByVal args() As String)
        ...
        '<snippetOCS_VB_Basic_Synchronize>
...
Public Class SampleSyncAgent
    ...
    Public Sub New()
        ...
        'DownloadOnly.
        '<snippetOCS_VB_Basic_CustomerSyncTable>
...
Public Class SampleServerSyncProvider
    ...
    Public Sub New()
        ...
        'your queries.
        '<snippetOCS_VB_Basic_NewAnchorCommand>
        ...
        '<snippetOCS_VB_Basic_CustomerAdapterBuilder>
...
Public Class SampleStats
    ...
    Public Sub DisplayStats(ByVal syncStatistics As SyncStatistics, ByVal syncType As String)
        ...
        '<snippetOCS_VB_Basic_Statistics>

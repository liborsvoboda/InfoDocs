...
'<snippetOCS_VB_Bidirectional_SampleSyncAgent>
Public Class SampleSyncAgent
    ...
    Public Sub New()
        ...
        '<snippetOCS_VB_Bidirectional_CustomerSyncTable>
...
Public Class SampleServerSyncProvider
    ...
    Public Sub New()
        ...
        'your queries.
        '<snippetOCS_VB_Bidirectional_NewAnchorCommand>
        ...
        '<snippetOCS_VB_Bidirectional_CustomerIncrUpdate>
        ...
        '<snippetOCS_VB_Bidirectional_CustomerUpdate>

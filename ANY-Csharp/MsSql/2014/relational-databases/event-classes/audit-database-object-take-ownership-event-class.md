...
|**ObjectType**|**int**|Value representing the type of the object involved in the event. The value returned for this column is a combination of the corresponding value in the **type** column in the **sys.objects** catalog view and the values listed in [ObjectType Trace Event Column](objecttype-trace-event-column.md). For example, if 8277-U is returned, the object type is user-defined table.|28|Yes|  
